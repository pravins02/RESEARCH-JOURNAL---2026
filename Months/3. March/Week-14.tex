...
\begin{enumerate}
    ...
    \item Saw the jobs posting of the physics teacher at Thomas Jefferson High School for Science and Technology, and I should apply for that as well. \cmark
    \item I will work on the cover letter tomorrow right after coming back from Yi-Cheng's defense. \cmark
\end{enumerate}
% \subsection*{Focused Tasks of the day}
% \begin{enumerate}[\ding{212}]  
%     \item  
...
\subsection*{Focused Tasks of the day}
\begin{enumerate}[\ding{212}]  
    \item Complete the cover letter for the physics teacher job and complete the application at FCPS. \cmark
\end{enumerate}
\subsection*{Notes:}
\begin{enumerate}
    \item Completed the website with update details of the teaching and also the blog post about the recent Oral presentation at the $70^{th}$ Annual MMM conference in 2025. 
\end{enumerate}
\stardivider
