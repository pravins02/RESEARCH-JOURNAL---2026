...
% \usepackage[T1]{fontenc}
% \usepackage[sfdefault]{roboto}  % Makes Roboto the default sans-serif
...
\usepackage{charter} % assumes new font selection scheme installed
...
%Set the hyphenation management
\usepackage{ragged2e}
...
% Define DodgerBlue (if not already defined)
\definecolor{dodgerblue}{RGB}{30,144,255}

% Global style
\tcbset{
  commonbox/.style={
    colback=dodgerblue!12,   % light DodgerBlue background
    colframe=dodgerblue!75!white,
    boxrule=0.9pt,
    arc=4pt,
    left=6pt,
    right=6pt,
...
% One-call general box
\newtcolorbox{infobox}[1]{
  commonbox,
  title=\textcolor{black}{\bfseries #1},
  coltitle=black
}


\newtcolorbox{physicsmodule}[3][]{%
  enhanced,
  colback=#3!4, colframe=#3!70!black,
  boxrule=0.8pt, arc=2mm,
  left=6pt,right=6pt,top=6pt,bottom=6pt,
  title=\sffamily\bfseries #2,
  coltitle=white,
  attach boxed title to top left={yshift=-2mm, xshift=0mm},
  boxed title style={colback=#3!85!black, colframe=#3!85!black, arc=2mm, outer arc=2mm},
  #1
}

% Inner white content box (the big white area with the numbered list)
